...
export const Ticketbookingform = () => {
  ...
  const paymentFunction = (e) => {
    ...
    e.preventDefault();
    var options = {
      key: "rzp_test_uLS7Kdi9Eo5POl",
      key_secret: "ZU8kaACgBT1HbzbxUWT3pMIv",
  ...
  return (
    <div class="form-container sign-in-container" className="ticket-booking">
      ...
      >
        <input name="movie_name" type="text" value={moviename} />
        <input name="booking_date" type="text" value={bookingdate} readOnly />
        ...
        <div class="displayerBoxes">
          <center>
            ...
            >
              ...
              <tr>
                <td>
                  <textarea name="user_name" id="nameDisplay" />
                </td>
                <td>
                  <textarea name="seat_number" id="NumberDisplay" />
                </td>
                <td>
                  <textarea name="seat_display" id="seatsDisplay" />
                </td>
              </tr>
            </table>
          </center>
